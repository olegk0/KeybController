...
# ATMega8 fusesvnehniy kvarc 32.768 êÃö)
# Fuse high byte:default 0xD9
# 0xD9
# 1 1 0 1 1 0 0 1 <-- BOOTRST (1-boot reset vector at 0x0000 0-Boot Loader vector)
...
# +-------------------- Select AT90S8535 compatibility mode 

# Fuse low byte:default 0xE1
# 0xE3
# 1 1 1 0 0 0 1 1
# ^ ^ \ / \--+--/
# | |  |     +--------- CKSEL 3..0 (int RC 4MHz)
# | |  +--------------- SUT 1..0
# | +------------------ BODEN (BrownOut Detector)
# +-------------------- BODLEVEL

#AVRDUDE_WRITE_FUSE = -U lfuse:w:0xE3:m
